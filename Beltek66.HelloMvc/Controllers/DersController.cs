...
namespace Beltek66.HelloMvc.Controllers
{
    public class DersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("DersId,DersAdi,OgretmenId,Bolum")] Ders ders)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("DersId,DersAdi,OgretmenId,Bolum")] Ders ders)
        {
            if (id != ders.DersId)
            {
                return NotFound();
